    ...
    <nav className="fixed top-0 left-0 right-0 z-[100] px-4 py-4 md:px-6 md:py-6">
      <div className="max-w-7xl mx-auto w-full flex items-center justify-between bg-white px-4 py-4 md:px-8 md:py-5 rounded-2xl md:rounded-3xl relative z-20 border border-white shadow-2xl shadow-[#1F2F5A]/5">
        ...
        <div className="hidden md:flex items-center gap-8 text-[#1F2F5A]/60 font-bold uppercase text-xs tracking-widest">
          ...
          <div className="flex items-center gap-4">
            <a href="https://wa.me/919845133461" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-4 py-2 bg-[#25D366]/10 text-[#25D366] rounded-full hover:bg-[#25D366] hover:text-white transition-all border border-[#25D366]/20">
            ...
            <a href="tel:+919845133461" className="px-6 py-2.5 bg-[#1F2F5A] text-white rounded-xl hover:bg-[#F57C00] transition-all shadow-lg shadow-[#1F2F5A]/20 font-bold">Start Nesting</a>
          </div>
        </div>
        ...
        >
          <a href="https://wa.me/919845133461" target="_blank" rel="noopener noreferrer" className="w-8 h-8 flex items-center justify-center text-[#25D366]">
      ...
      {isMenuOpen && (
        <div className="md:hidden mt-4 bg-white p-8 rounded-[2rem] flex flex-col gap-8 text-center animate-reveal relative z-10 shadow-[0_20px_50px_rgba(0,0,0,0.1)] border border-[#1F2F5A]/5">
          ...
          <a href="tel:+919845133461" className="flex items-center justify-center gap-4 px-6 py-5 bg-[#1F2F5A] text-white rounded-2xl font-black uppercase text-sm tracking-[0.2em] shadow-xl shadow-[#1F2F5A]/20">
