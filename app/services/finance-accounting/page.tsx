...
const data = {
  ...
  icon: "💰",
  tagline: "Precision Wealth Management",
  description: "Every rupee matters. Our experts provide sophisticated accounting and tax planning to maximize your bottom line.",
  features: [
    { title: "Cloud Bookkeeping", desc: "Real-time access to your financial health, anywhere." },
    { title: "Strategic Tax Planning", desc: "Minimizing liability legally and effectively." },
    { title: "Internal Audits", desc: "Ensuring your business is leak-proof and efficient." }
  ],
  process: ["Onboarding", "Process Setup", "Regular Bookkeeping", "Monthly Review", "Strategic Advice"],
  benefits: ["Error-Free Reporting", "Maximized Profitability", "Audit Confidence"]
};
        ...
        <div className="max-w-7xl mx-auto relative z-10 grid md:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            ...
            <div className="flex gap-4 animate-reveal [animation-delay:400ms]">
              <a href="https://wa.me/919008011333" target="_blank" rel="noopener noreferrer" className="px-10 py-5 bg-[#1F2F5A] text-white rounded-2xl font-black text-lg shadow-xl shadow-[#1F2F5A]/20">Get Started on WhatsApp →</a>
            </div>
          </div>
