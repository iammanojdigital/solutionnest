...
const data = {
  ...
  description: "We build more than just websites. We engineer high-conversion digital experiences that serve as the foundation of your digital empire.",
  features: [
    { title: "Next.js Excellence", desc: "Lightning-fast performance and SEO-first architecture." },
    { title: "E-Commerce Heavyweights", desc: "Scalable stores with seamless checkout journeys." },
    { title: "Interactive UI/UX", desc: "Cinematic animations that engage every visitor." }
  ],
  process: ["Discovery & Strategy", "Design Mockups", "Agile Development", "Quality Assurance", "Global Launch"],
  benefits: ["Sub-1s Load Times", "Mobile-First Responsiveness", "Higher ROI Tracking"]
};
