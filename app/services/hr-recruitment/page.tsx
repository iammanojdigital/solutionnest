        ...
        <div className="max-w-7xl mx-auto relative z-10 grid md:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            ...
            <div className="flex gap-4 animate-reveal [animation-delay:400ms]">
              <a href="https://wa.me/919008011333" target="_blank" rel="noopener noreferrer" className="px-10 py-5 bg-[#1F2F5A] text-white rounded-2xl font-black text-lg shadow-xl shadow-[#1F2F5A]/20">Hire Top Talent on WhatsApp →</a>
            </div>
          </div>
