...
const data = {
  ...
  description: "Don't let bureaucracy slow you down. We handle the paperwork, so you can focus on building your vision from day one.",
  features: [
    { title: "LLC & Private Limited", desc: "Expert guidance on the best structure for your growth." },
    { title: "Foreign Subsidiary", desc: "Seamless expansion into international markets." },
    { title: "Virtual Office Setup", desc: "Immediate presence in premium business hubs." }
  ],
  process: ["Documentation", "Application Filing", "MoA & AoA Draft", "Payment Processing", "COI Issuance"],
  benefits: ["100% Legal Accuracy", "Fast-Track Approval", "Peace of Mind"]
};
