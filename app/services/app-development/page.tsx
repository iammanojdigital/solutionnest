...
const data = {
  ...
  description: "Transform your business idea into a powerful mobile application. We specialize in cross-platform excellence that feels native on every device.",
  features: [
    { title: "iOS & Android", desc: "Single codebase, dual-platform dominance with React Native." },
    { title: "Cloud Integration", desc: "Robust backends built on Firebase and AWS." },
    { title: "Offline Readiness", desc: "Seamless performance even in low-connectivity zones." }
  ],
  process: ["User Journey Mapping", "Prototyping", "Full-Stack Dev", "Device Testing", "App Store Deployment"],
  benefits: ["Push Notification Power", "High User Engagement", "Real-Time Data Sync"]
};
